...
final class HomeRootViewController: BaseViewController {
    ...
    override func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            tabBarView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 18),
            tabBarView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -18),
            tabBarView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -4),
